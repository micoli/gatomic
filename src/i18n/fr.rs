...
pub static FR: Strings = Strings {
    ...
    short_quit: "q : quitter",
    short_hunk_accept_reject_advance: "y/n : acc/rej hunk",
    short_hunk_accept_reject_rest: "a/d : acc/rej hunk + fichier",
    short_hunk_next_prev: "j/k : hunk",
    short_hunk_next_prev_undecided: "J/K : hunk non décidé",
    short_hunk_split: "s : découper hunk",
    short_hunk_toggle: "Espace : toggle",
    short_commit_fixup: "x : fixup",
    short_commit_green_check: "✓ : fichier dans commit",
    short_language: "l : langue",
